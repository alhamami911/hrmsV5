...
class AdmasHRMSConfiguration(models.TransientModel):
    ...
    module_admasHrms_hr_lawsuit_management = fields.Boolean(
    ...
    module_admasHrms_hr_zk_attendance = fields.Boolean(
    ...
    test_module_hr_insurance = fields.Boolean(string="HR Insurance",
                                              ...
                                              default=False, invisible=True)
    test_module_admasHrms_hr_lawsuit_management = fields.Boolean(
    ...
    test_module_hr_vacation_mngmt = fields.Boolean(string="Vacation Management",
                                                   ...
                                                   default=False,
                                                   invisible=True)
    test_module_admasHrms_hr_zk_attendance = fields.Boolean(string="Attendance",
    ...
    @api.onchange('module_admasHrms_hr_lawsuit_management')
    def onchange_module_admasHrms_hr_lawsuit_management(self):
        """Return admasHrms_hr_lawsuit_management module exist or not"""
        for each in self:
            if each.module_admasHrms_hr_lawsuit_management:
                if not self.env['ir.module.module'].search(
                        [('name', '=', 'admasHrms_hr_lawsuit_management')]):
                    each.test_module_admasHrms_hr_lawsuit_management = True
                    each.module_admasHrms_hr_lawsuit_management = False
                else:
                    each.test_module_admasHrms_hr_lawsuit_management = False
    ...
    @api.onchange('module_admasHrms_hr_zk_attendance')
    def onchange_module_admasHrms_hr_zk_attendance(self):
        """Return admasHrms_hr_zk_attendance module exist or not"""
        for each in self:
            if each.module_admasHrms_hr_zk_attendance:
                if not self.env['ir.module.module'].search(
                        [('name', '=', 'admasHrms_hr_zk_attendance')]):
                    each.test_module_admasHrms_hr_zk_attendance = True
                    each.module_admasHrms_hr_zk_attendance = False
                else:
                    each.test_module_admasHrms_hr_zk_attendance = False
